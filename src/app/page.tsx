  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-[#0a0a0a]/95 backdrop-blur-md py-4 border-b border-[#c9a962]/10"
          : "bg-transparent py-6"
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between">
        <a href="#inicio" className="flex items-center gap-3 group">
          ...
          <div className="hidden sm:block">
            <span className="font-display text-lg tracking-wider text-[#e8e4dc] group-hover:text-[#c9a962] transition-colors">
              DESPACHO INFANTE
            </span>
          </div>
        </a>
        ...
        <div className="hidden lg:flex items-center gap-10">
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="text-sm tracking-widest uppercase text-[#a8a49c] hover:text-[#c9a962] transition-colors duration-300 hover-gold-line pb-1"
            >
              {link.label}
            </a>
          ))}
        ...
        <button
          ...
          className="lg:hidden p-2 text-[#e8e4dc] hover:text-[#c9a962] transition-colors"
          type="button"
        >
      ...
      {/* Mobile Menu */}
      <div
        className={`lg:hidden absolute top-full left-0 right-0 bg-[#0a0a0a]/98 backdrop-blur-md border-b border-[#c9a962]/10 transition-all duration-300 ${
        ...
        <div className="px-6 py-8 flex flex-col gap-6">
          {navLinks.map((link) => (
            <a
              ...
              className="text-sm tracking-widest uppercase text-[#a8a49c] hover:text-[#c9a962] transition-colors"
            >
              {link.label}
            </a>
          ))}
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#0a0a0a]">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full opacity-5">
          <div className="absolute inset-0" style={{
            background: 'repeating-linear-gradient(45deg, transparent, transparent 50px, #c9a962 50px, #c9a962 51px)',
          }} />
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-32 text-center">
        <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <div className="inline-flex items-center gap-4 mb-8">
            ...
            <span className="text-[#c9a962] text-sm tracking-[0.3em] uppercase font-body">Abogados de Élite</span>
            <span className="h-px w-12 bg-[#c9a962]" />
          </div>
        </div>

        <h1
          className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-[#e8e4dc] mb-8 leading-[1.1] animate-slide-up"
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
        <span className="text-[#a8a49c] text-xs tracking-widest uppercase">Scroll</span>
...
function StatsSection() {
  ...
  return (
    <section className="relative py-20 bg-[#0f0f0f] border-y border-[#c9a962]/10">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="font-display text-4xl md:text-5xl lg:text-6xl text-[#c9a962] mb-2">
                {stat.number}
              </div>
              <div className="text-sm tracking-widest uppercase text-[#a8a49c]">
                {stat.label}
              </div>
            </div>
          ))}
...
function AboutSection() {
  return (
    <section id="nosotros" className="relative py-24 lg:py-32 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          {/* Left Column - Image */}
          <div className="relative">
            <div className="aspect-[4/5] bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] relative overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-24 h-24 border border-[#c9a962]/30 mx-auto mb-6 flex items-center justify-center">
                  ...
                  <p className="text-[#a8a49c] text-sm tracking-widest uppercase">Justicia y Excelencia</p>
                </div>
              </div>
              {/* Decorative frame */}
              <div className="absolute top-4 left-4 right-4 bottom-4 border border-[#c9a962]/20" />
            </div>
            {/* Floating accent */}
            <div className="absolute -bottom-6 -right-6 w-32 h-32 border border-[#c9a962]/30" />
          </div>
          ...
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-[#e8e4dc] mb-8 leading-tight">
              Tradición de
              <br />
...
function ServicesSection() {
  ...
  return (
    <section id="servicios" className="relative py-24 lg:py-32 bg-[#0f0f0f]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-24">
          ...
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-[#e8e4dc] mb-6">
            Servicios <span className="text-[#c9a962] italic">Juridicos</span>
          </h2>
          <p className="max-w-2xl mx-auto text-[#a8a49c] leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="group relative p-8 bg-[#0a0a0a] border border-[#1a1a1a] hover:border-[#c9a962]/30 transition-all duration-500"
            >
              {/* Corner accents */}
              <div className="absolute top-0 left-0 w-8 h-8 border-t border-l border-[#c9a962]/0 group-hover:border-[#c9a962]/50 transition-all duration-500" />
              <div className="absolute bottom-0 right-0 w-8 h-8 border-b border-r border-[#c9a962]/0 group-hover:border-[#c9a962]/50 transition-all duration-500" />

              <div className="text-[#c9a962] mb-6 group-hover:scale-110 transition-transform duration-300">
                {service.icon}
              </div>
              <h3 className="font-display text-2xl text-[#e8e4dc] mb-4 group-hover:text-[#c9a962] transition-colors duration-300">
                {service.title}
              </h3>
              <p className="text-[#a8a49c] leading-relaxed text-sm">
                {service.description}
              </p>

              <div className="mt-6 pt-6 border-t border-[#1a1a1a] group-hover:border-[#c9a962]/20 transition-colors duration-300">
                <a
                  href="#contacto"
                  className="inline-flex items-center gap-2 text-sm text-[#c9a962] opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                >
                  Saber mas
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
...
function TeamSection() {
  ...
  return (
    <section id="equipo" className="relative py-24 lg:py-32 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        {/* Section Header */}
        <div className="text-center mb-16 lg:mb-24">
          <div className="inline-flex items-center gap-4 mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          {team.map((member, index) => (
            <div
              key={index}
              className="group relative flex flex-col sm:flex-row gap-6 p-6 bg-[#0f0f0f] border border-[#1a1a1a] hover:border-[#c9a962]/30 transition-all duration-500"
            >
              {/* Avatar placeholder */}
              <div className="flex-shrink-0 w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border border-[#c9a962]/20 flex items-center justify-center">
              ...
              <div className="flex-1">
                ...
                <h3 className="font-display text-2xl text-[#e8e4dc] mb-1 group-hover:text-[#c9a962] transition-colors duration-300">
                  {member.name}
                </h3>
                <div className="text-sm text-[#a8a49c] mb-4">{member.role}</div>
                <p className="text-[#a8a49c] text-sm leading-relaxed">
                  {member.description}
                </p>
              </div>
            </div>
  ...
  return (
    <section className="relative py-24 lg:py-32 bg-[#0f0f0f] overflow-hidden">
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] border border-[#c9a962] rounded-full" />
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
        <svg className="w-16 h-16 mx-auto mb-8 text-[#c9a962] opacity-50" fill="currentColor" viewBox="0 0 24 24">
          <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
        </svg>

        <blockquote className="font-display text-2xl md:text-3xl lg:text-4xl text-[#e8e4dc] mb-8 leading-relaxed italic">
        ...
        <div>
          ...
          <div className="text-sm text-[#a8a49c] tracking-wider uppercase mt-1">Empresario, Madrid</div>
        </div>
      </div>
    </section>
  );
